-- Drop existing views if they exist (to handle column mismatch)
DROP VIEW IF EXISTS public.blog_proposal_stats CASCADE;
DROP VIEW IF EXISTS public.blog_comments_with_authors CASCADE;
...
CREATE VIEW public.blog_comments_with_authors AS
SELECT 
    bc.*,
    p.display_name as author_name,
    p.username as author_username,
