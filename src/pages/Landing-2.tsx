  ...
  const MemberCard = ({ member }: { member: typeof members[0] }) => (
    <figure className={cn(
      ...
      <div className="flex flex-row items-center gap-2">
        <img className="rounded-full" width="32" height="32" alt="" src={member.image} />
          ...
          <section className="relative min-h-[80vh] flex items-center justify-center px-6 py-20">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="relative max-w-4xl mx-auto mb-16">
                <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl border shadow-xl flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 bg-[#3D63DD] rounded-full flex items-center justify-center mx-auto mb-4 cursor-pointer hover:bg-[#2D53CD] transition-colors">
                    ...
                    <p className="text-sm text-muted-foreground">
                      See how Goodable transforms policy work
                    </p>
                  </div>
                </div>
              </div>
