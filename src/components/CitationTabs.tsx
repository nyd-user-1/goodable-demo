...
export function CitationTabs({ bills, sources, relatedBills = [], onCitationClick }: CitationTabsProps) {
  ...
  return (
    <div className="mt-4 pt-4 border-t">
      <Tabs defaultValue={hasBills ? "bills" : hasRelated ? "related" : "sources"} className="w-full">
        ...
        {/* References Tab (formerly Referenced Bills) */}
        ...
        {/* Resources Tab (formerly Research Sources) */}
