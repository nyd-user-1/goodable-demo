...
import { MessageSquare, MessagesSquare, ScrollText, Users, Landmark, TrendingUp, Target, Gamepad2, Factory, Home, User, CreditCard, Clock, Shield, Palette, Image as ImageIcon, ChevronRight, PanelLeftClose, PanelLeft, MoreHorizontal, Pin, Trash2, PenSquare, TextQuote, Pencil, Wallet, GraduationCap, BookCheck } from "lucide-react";
